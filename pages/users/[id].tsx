...
import { GET_USERIDS, GET_USERBY_ID } from '../../queries'
import {
  GetUserIdsQuery,
  GetUserByIdQuery,
  Users,
...
const UserDetailPage: VFC<Props> = ({ user }) => {
  if (!user) {
...
export const getStaticProps: GetStaticProps<{ user: Props['user'] }, Params> = async ({ params }) => {
  const apolloClient = initializeApollo()
